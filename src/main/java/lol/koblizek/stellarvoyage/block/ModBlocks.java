...
import lol.koblizek.stellarvoyage.block.tileentity.bloomery.BloomeryTileEntityBlock;
...
public class ModBlocks implements References {
    ...
    public static final BloomeryTileEntityBlock BLOOMERY = registerBlock("bloomery_fired",
            new BloomeryTileEntityBlock());
