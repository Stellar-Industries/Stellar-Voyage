...
public class ModItems implements References {
    ...
    public static final Item PEBBLE_PICKAXE = registerItem("pebble_pickaxe.json", new PickaxeItem(ToolMaterials.WOOD, 1, -2.8F, new Item.Settings()));
    public static final Item WOODEN_BAT = registerItem("wooden_bat", new SwordItem(ToolMaterials.WOOD, 3, -2.4F, new Item.Settings()));
    public static final Item PEBBLE_SHOVEL = registerItem("pebble_shovel.json", new ShovelItem(ToolMaterials.WOOD, 1, -2F, new Item.Settings()));
